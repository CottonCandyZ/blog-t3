      ...
      typography: {
        primary: {
          css: {
            ...
            '--tw-prose-lead': "rgb(var(--color-primary-dark))",
            '--tw-prose-links': "rgb(var(--color-primary-dark))",
            '--tw-prose-bold': "rgb(var(--color-primary-dark))",
            '--tw-prose-counters': "rgb(var(--color-primary-dark))",
            ...
            '--tw-prose-code': "rgb(var(--color-primary-dark))",
            '--tw-prose-pre-code': "rgb(var(--color-primary-dark))",
            '--tw-prose-pre-bg': "rgb(var(--color-primary-dark))",
